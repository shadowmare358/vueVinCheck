<template>
  <div class="search">
   ...
   <p v-for="result in vinResults" v-bind:key="result.id">Year {{result}}</p>
   <p v-for="result in vinResults" v-bind:key="result.id">Manufacturer {{result}}</p>
   <p v-for="result in vinResults" v-bind:key="result.id">Model {{result}}</p>
    </ul>
