<template>
  <div class="search">
   ...
   <p v-for="result in vinResults" v-bind:key="result.id">Year {{result[0]}}</p>
   <p v-for="result in vinResults" v-bind:key="result.id">Manufacturer {{result[0]}}</p>
   <p v-for="result in vinResults" v-bind:key="result.id">Model {{result[0]}}</p>
    </ul>
